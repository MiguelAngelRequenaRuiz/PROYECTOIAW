...
<body>
  ...
  <div id="principal">
    ...
    <?php
            ...
            echo "<table>";
            echo "<tr><th colspan='3' style='font-size:25px'>Fotos subidas por ". $usuario. "</th></tr>";
    ...
    <div class="pder" >
      ...
      <div class="contenido" style="height: 600px">
        ...
        <div class="formulario">
          ...
          <form id="imagen" action="agregar_imagenes.php" method="post" enctype="multipart/form-data">
